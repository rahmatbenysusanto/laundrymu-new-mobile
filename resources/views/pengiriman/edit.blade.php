...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a href="#" class="title-page">Edit Pengiriman</a></div>
            <div>
            </div>
        </div>
    </div>
...
<div class="page-content-wrapper">
    ...
    <div class="container pt-3">
        <div class="row">
            <div class="col-12">
                <div class="card p-2">
                    <form action="{{ route('editPengiriman') }}" method="POST">
                        @csrf
                        <input type="hidden" value="{{ $pengiriman->id }}" name="id">
                        <div class="form-group">
                            <label class="form-label" for="nama">Nama Layanan</label>
                            <input class="form-control" value="{{ $pengiriman->nama }}" id="nama" type="text" placeholder="Masukan nama layanan" name="nama" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="harga">Harga Pengiriman</label>
                            <div class="input-group mb-3"><span class="input-group-text" id="basic-addon1">Rp</span>
                                <input class="form-control" value="{{ $pengiriman->harga }}" type="number" name="harga" id="harga" required>
                            </div>
                        </div>
