...
<body>
    ...
    <div class="header-area" id="headerArea">
        <div class="container">
            <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
                ...
                <div class="logo-wrapper"><a href="#" class="title-page">Daftar Pengiriman</a></div>
                <div class="user-profile-wrapper">
                    <a href="{{ route('pengirimanCreate') }}" class="text-black">
    ...
    <div class="page-content-wrapper">
        ...
        <section id="list-transaksi-header">
            <div class="container">
                <div class="pb-3 pt-3">
                    <input type="text" class="form-control" placeholder="Cari nama pengiriman" id="search">
                </div>
            </div>
        </section>
        ...
        <div class="mt-3"></div>
        <div class="container">
            <table class="w-100" id="listParfum">
                <thead>
                <tr>
                    <th></th>
                </tr>
                ...
                <tbody>
                @foreach($pengiriman as $par)
                    <tr>
                        <td>
                            <div class="card p-2 mb-3">
                                <p class="text-nama">{{ $par->nama }}</p>
                                <p class="text-harga">Rp.{{ number_format($par->harga) }}</p>
                                <div class="row mt-3">
                                    <div class="col-10">
                                        <a href="/edit-pengiriman/{{ base64_encode($par->id) }}" class="btn btn-putih">Ubah</a>
                                    </div>
                                    <div class="col-2">
                                        <a onclick="pilihan('{{ $par->id }}')" class="btn btn-icon">
    ...
    <script>
        let table = $("#listParfum").DataTable({
            paging: false,
            order: false
        });
        ...
        function pilihan(id) {
            ...
            <a onclick="hapusParfum('${id}')">
                <div class="d-flex align-items-center align-content-center">
                    ...
                    <span class="menu-modal-danger ms-2">Hapus Pengiriman</span>
                </div>
            </a>
        `;
        }
