...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a href="#" class="title-page">Tambah Layanan</a></div>
            <div>
            </div>
        </div>
    </div>
...
<div class="page-content-wrapper">
    ...
    <div class="container pt-3">
        <div class="row">
            <div class="col-12">
                <div class="card p-2">
                    <form action="{{ route('tambahLayananProses') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label class="form-label" for="nama">Nama Layanan</label>
                            <input class="form-control" id="nama" type="text" placeholder="Masukan nama layanan" name="nama" required>
                        </div>
                        <div class="form-group">
