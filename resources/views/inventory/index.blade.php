...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a href="#" class="title-page">Daftar Inventory</a></div>
            <div class="user-profile-wrapper">
                <a href="{{ route('tambahBarang') }}" class="text-black">
                ...
                <tr>
                    <td>
                        <div class="card p-2 mb-3">
                            <p class="nama-barang">{{ $inv->nama_barang }}</p>
                            <p>Stock : {{ $inv->stock }} {{ $inv->nama_satuan }}
                                @if($inv->stock < $inv->stock_minimum)
                                    <span class="text-danger"> (Stock dibawah minimum)</span>
                                @endif
                            </p>
                            <p>Stock Minimum : {{ $inv->stock_minimum }}</p>
                            <div class="row mt-3">
                                <div class="col-10">
                                    <a href="/edit-barang/{{ $inv->barang_id }}" class="btn btn-putih">Ubah</a>
                                </div>
                                <div class="col-2">
                                    <a onclick="pilihan('{{ $inv->barang_id }}')" class="btn btn-icon">
        ...
        document.getElementById('modalPilihan').innerHTML = `
            <a onclick="hapusParfum('${id}')">
                <div class="d-flex align-items-center align-content-center">
                    ...
                    <span class="menu-modal-danger ms-2">Hapus Barang</span>
                </div>
            </a>
        `;
    }
