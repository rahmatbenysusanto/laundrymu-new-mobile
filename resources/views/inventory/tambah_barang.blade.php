...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a href="#" class="title-page">Tambah Barang</a></div>
            <div>
            </div>
        </div>
    </div>
...
<div class="page-content-wrapper">
    ...
    <div class="container pt-3">
        <div class="row">
            <div class="col-12">
                <div class="card p-2">
                    <form action="{{ route('tambahBarangProses') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label class="form-label" for="nama">Nama Barang</label>
                            <input class="form-control" id="nama" type="text" placeholder="Masukan nama barang" name="nama" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="stock">Stock Minimum</label>
                            <input class="form-control" id="stock" type="number" placeholder="Masukan stock minimum" name="stock_minimum" required>
                        </div>
                        <div class="form-group">
