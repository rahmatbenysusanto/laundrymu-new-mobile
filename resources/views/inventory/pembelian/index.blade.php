...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a href="#" class="title-page">Pembelian Barang</a></div>
            <div class="user-profile-wrapper">
                <a href="{{ route('tambahPembelianBarang') }}" class="text-black">
                ...
                <tr>
                    <td>
                        <div class="card p-2 mb-3">
                            <p class="nama-barang">{{ $pem->nama_barang }}</p>
                            <p>Jumlah : {{ $pem->qty }}</p>
                            <p>Harga Satuan : Rp{{ number_format($pem->harga) }}</p>
                            <p>Total Harga : Rp{{ number_format($pem->total_harga) }}</p>
                            <p>Tanggal : {{ tanggal_indo($pem->tanggal_pembelian) }}</p>
                            <div class="row mt-3">
                                <div class="col-10">
                                    <a href="" class="btn btn-putih">Detail</a>
                                </div>
                                <div class="col-2">
