...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a href="#" class="title-page">Tambah Pembelian Barang</a></div>
            <div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card p-2 mb-4">
                    <form action="{{ route('tambahPembelianProses') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label class="form-label" for="barang">Barang</label>
                            <select class="form-control" name="barang_id" id="barang" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="qty" type="number" placeholder="Masukan jumlah barang" name="qty" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="harga">Harga</label>
                            <input class="form-control" id="harga" type="number" placeholder="Masukan harga barang" name="harga" required>
                        </div>
                        <div class="form-group">
                        ...
                        <button class="btn btn-primary w-100 d-flex align-items-center justify-content-center" type="submit">Buat Pembelian Barang</button>
                    </form>
                </div>
            </div>
        </div>
