...
<body>
    ...
    <div class="header-area" id="headerArea">
        <div class="container">
            <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
                ...
                <div class="logo-wrapper"><a href="#" class="title-page">Daftar Pelanggan</a></div>
                <div class="user-profile-wrapper">
                    <a href="{{ route('tambahPelanggan') }}" class="text-black">
    ...
    <div class="page-content-wrapper">
        ...
        <section id="list-transaksi-header">
            <div class="container">
                <div class="pb-3 pt-3">
                    <input type="text" class="form-control" placeholder="Cari nama pelanggan" id="search">
                </div>
            </div>
        </section>
        ...
        <div class="mt-3"></div>
        <div class="container">
            <table class="w-100" id="listPelanggan">
                <thead>
                <tr>
                    <th></th>
                </tr>
                ...
                <tbody>
                @foreach($pelanggan as $par)
                    <tr>
                        <td>
                            <div class="card p-2 mb-3">
                                <p class="text-nama">{{ $par->nama }}</p>
                                <p class="text-tipe">{{ $par->no_hp }}</p>
                                <div class="row mt-3">
                                    <div class="col-10">
                                        <a href="/edit-pelanggan/{{ base64_encode($par->id) }}" class="btn btn-putih">Ubah</a>
                                    </div>
                                    <div class="col-2">
    ...
    <script>
        let table = $("#listPelanggan").DataTable({
            paging: false,
            order: false
        });
        ...
        function pilihan(id) {
            ...
            <a onclick="hapusPelanggan('${id}')">
                <div class="d-flex align-items-center align-content-center">
                    ...
                    <span class="menu-modal-danger ms-2">Hapus Pelanggan</span>
                </div>
            </a>
        `;
        }
