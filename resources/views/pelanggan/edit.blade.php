    ...
    <div class="header-area" id="headerArea">
        <div class="container">
            <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
                ...
                <div class="logo-wrapper"><a href="#" class="title-page">Edit Pelanggan</a></div>
                <div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card p-2">
                        <form action="{{ route('prosesEditPelanggan') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" value="{{ $pelanggan->nama }}" id="nama" type="text" placeholder="Masukan nama pelanggan" name="nama" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="harga">No Hp</label>
                                <div class="input-group mb-3">
                                    <input class="form-control" value="{{ $pelanggan->no_hp }}" type="number" name="no_hp" id="harga" required>
                                </div>
                            </div>
