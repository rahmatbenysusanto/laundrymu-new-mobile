...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a href="#" class="title-page">Edit Diskon</a></div>
            <div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card p-2">
                    <form action="{{ route('prosesEditDiskon') }}" method="POST">
                        @csrf
                        <input type="hidden" value="{{ $diskon->id }}" name="id">
                        <div class="form-group">
                            <label class="form-label" for="nama">Nama Diskon</label>
                            <input class="form-control" value="{{ $diskon->nama }}" id="nama" type="text" placeholder="Masukan nama layanan" name="nama" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="nama">Tipe Diskon</label>
                        ...
                        <div class="form-group">
                            <label class="form-label" for="harga">Harga Diskon</label>
                            <div class="input-group mb-3">
                                @if($diskon->type == "nominal")
                                    <span class="input-group-text" id="basic-addon1">Rp</span>
                                @endif
                                <input class="form-control" value="{{ $diskon->nominal }}" type="number" name="nominal" id="harga" required>
                                @if($diskon->type == "presentase")
