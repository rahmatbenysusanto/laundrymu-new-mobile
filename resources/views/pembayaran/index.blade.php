    ...
    <div class="header-area" id="headerArea">
        <div class="container">
            <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
                ...
                <div class="logo-wrapper"><a href="#" class="title-page">Daftar Pembayaran</a></div>
                <div class="user-profile-wrapper">
                    <a href="{{ route('tambahPembayaran') }}" class="text-black">
                    ...
                    <tr>
                        <td>
                            <div class="card p-2 mb-3">
                                ...
                                <div class="row mt-3">
                                    <div class="col-10">
                                        <a href="/edit-pembayaran/{{ base64_encode($par->id) }}" class="btn btn-putih">Ubah</a>
                                    </div>
                                    <div class="col-2">
