...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a class="title-page">Notifikasi Detail</a></div>
            <div>
        ...
        <div class="row pt-1">
            <div class="col-12">
                <div class="card card-white p-2">
                    ...
                    <div class="notif-text mb-2">{{ $notification->type }} - {{ formatTanggal($notification->created_at) }}</div>
